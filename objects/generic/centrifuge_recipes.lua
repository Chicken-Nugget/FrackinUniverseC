function getRecipes()
  return {
    ...
    itemMapBees = {
        ...
        coppercomb      = { copperore      = { "uncommon", 1 } },
        durasteelcomb   = { durasteelore   = { "rare", 1 } },
        forestcomb      = { goldenwood     = { "common", 1 } },
        flowercomb      = { petalred       = { "uncommon", 3 },
                            petalyellow    = { "uncommon", 3 },
                            petalblue      = { "uncommon", 3 } },
        godlycomb       = { matteritem     = { "uncommon", 1 } },
        goldcomb        = { goldore        = { "uncommon", 1 } },
        ironcomb        = { ironore        = { "uncommon", 1 } },
        junglecomb      = { goldenleaves   = { "common", 1 } },
        minercomb       = { coalore        = { "uncommon", 1 } },
        mooncomb        = { hematite       = { "uncommon", 1 } },
        ...
        silvercomb      = { silverore      = { "uncommon", 1 } },
        solariumcomb    = { solariumore    = { "rare", 1 } },
        suncomb         = { sulphur        = { "rare", 1 } },
        titaniumcomb    = { titaniumore    = { "rare", 1 } },
        tungstencomb    = { tungstenore    = { "rare", 1 } },
        volcaniccomb    = { liquidlava     = { "rare", 1 } },
        aegisaltcomb    = { aegisaltore    = { "rare", 1 } },
        feroziumcomb    = { feroziumore    = { "rare", 1 } },
        violiumcomb     = { violiumore     = { "rare", 1 } },
        magmacomb       = { corefragmentore = { "uncommon", 1 },
                            scorchedcore    = { "rare", 1 },
                            liquidlava      = { "common", 1 } },
        eldercomb       = { liquidelderfluid = { "rare", 1 },
